...
pub use showcase::{
    ...
    species_source_radius_m, terrain_height_m, ClassCounts,
    ...
    LILY_PAD_HEIGHT_M, ROUTE_PLAYER_CLEARANCE_M, SHOWCASE_SPECIES, SPECIES_LILY, TERRAIN_CELL_M, TILES_PER_EDGE, TILE_CELLS,
    WALK_SPEED_M_S,
};

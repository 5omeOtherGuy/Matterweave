...
pub use showcase::{
    build_showcase, carved, cell_centre_m, composition_hash, showcase_class, terrain_height_m,
    ClassCounts, ContentManifest, Landmark, Showcase, SurfacePoint, Terrain, BAND_CELLS,
    BASE_ROCK_ID, BASE_SOIL_ID, BASIN_CENTRE_M, BASIN_WATER_LEVEL_M, EYE_HEIGHT_M, MAP_EDGE_CELLS,
    MAP_EDGE_M, MAX_PROTOTYPE_CELLS, MAX_TERRAIN_CELL_Y, ROUTE_STEP_M, SHOWCASE_EXPANDED_CELLS_MIN,

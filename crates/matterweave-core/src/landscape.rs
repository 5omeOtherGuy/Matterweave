...
///
/// Version 3: biome boundaries are blend bands rather than thresholds, so a
...
/// different from what version 2 produced, and a v2 landscape save is rejected
/// by the recorded version rather than loading terrain that no longer exists.

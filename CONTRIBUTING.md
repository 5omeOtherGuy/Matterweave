...
Read [AGENTS.md](AGENTS.md), the [implementation handoff](docs/HANDOFF.md) and the
...
claims follow [the benchmark protocol](docs/BENCHMARKS.md).

## Handoffs and pull requests

Keep [STATUS.md](docs/STATUS.md) current: implemented behavior, actual validation,

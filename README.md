...
engine. See STATUS for delivered systems, exact evidence and open
gates.
...
See STATUS for exact evidence and limitations. Open milestone
...
2. Status and handoff: current state and continuity.
3. MVP scope, project brief and [requirements](docs/REQUIREMENTS.md).
4. [ADR index](docs/adr/README.md), [architecture](docs/ARCHITECTURE.md) and roadmap.
5. Dependencies, component selection
...
the dependency inventory; they do not license original
